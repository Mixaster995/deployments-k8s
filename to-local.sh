...
grep 'ref=94bde617f7939b9fd990840e80a6f2124e1c8e83' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=94bde617f7939b9fd990840e80a6f2124e1c8e83[a-z0-9]*/${root}\/\2/g" "${file}"
done
