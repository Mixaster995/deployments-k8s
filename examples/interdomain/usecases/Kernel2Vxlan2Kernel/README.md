...
```bash
NAMESPACE1=($(kubectl create -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/d5b90b83905c929b0de913370d96136492ad2a68/examples/interdomain/usecases/namespace.yaml)[0])
...
Create test namespace:
```bash
NAMESPACE2=($(kubectl create -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/d5b90b83905c929b0de913370d96136492ad2a68/examples/interdomain/usecases/namespace.yaml)[0])
