...
bases:
- https://github.com/networkservicemesh/deployments-k8s/apps/nsmgr?ref=94bde617f7939b9fd990840e80a6f2124e1c8e83
...
Restore NSMgr setup:
```bash
kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/apps/nsmgr?ref=94bde617f7939b9fd990840e80a6f2124e1c8e83 -n nsm-system
```
